        ...
        child: Column(
          ...
          children: <Widget>[
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  Expanded(
                    child: Center(
                      child: Text(
                        AppLocalization.of(context).translate('user_creation'),
            ...
            Container(
              ...
              child: Text(
                AppLocalization.of(context).translate('create_new_user'),
            ...
            Container(
              ...
              child: Text(
                AppLocalization.of(context).translate('user_type_text'),
