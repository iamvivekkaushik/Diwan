...
//            margin: EdgeInsets.fromLTRB(0, 0, 0, 10),
  ...
  Widget _createRow({String title, String subText, String path, var argument}) {
          ...
          Container(
            ...
            child: Align(
                ...
                child: Text(
                  subText,
                  style: path != null
                      ? settingSubTextActiveStyle
                      : settingSubTextInactiveStyle,
                )),
          )
        ],
      ),
